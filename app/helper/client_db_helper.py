...
def get_client_db_connection(client_id: str, db: Session = Depends(get_db)) -> psycopg2.extensions.connection:
...
def test_client_db_connection(client_id: str, db: Session = Depends(get_db)) -> bool:
